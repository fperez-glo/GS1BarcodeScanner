 ...
 */
    export default class BarCodeParser {
    ...
    parseBarcode(barcode) {
        ...
        function identifyAI(codestring) {
            console.log('codestring sin clean:',codestring)

            codestring = cleanCodestring(codestring);

            console.log('codestring con clean!!:',codestring)
